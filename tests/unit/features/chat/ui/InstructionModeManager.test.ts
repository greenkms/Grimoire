...
describe('InstructionModeManager', () => {
  it('should enter instruction mode on # keystroke when input is empty', () => {
    ...
    expect(wrapper.addClass).toHaveBeenCalledWith('grimoire-input-instruction-mode');
  });
  ...
  it('should exit instruction mode when input is cleared', () => {
    ...
    expect(wrapper.removeClass).toHaveBeenCalledWith('grimoire-input-instruction-mode');
  });
