...
class OpencodeAgentModal extends Modal {
  ...
  onOpen() {
    this.setTitle(this.existing
      ? t('settings.agentEditor.modalTitleEdit', { provider: 'OpenCode' })
      : t('settings.agentEditor.modalTitleAdd', { provider: 'OpenCode' }));
    ...
    new Setting(contentEl)
      ...
      .setDesc(t('settings.agentEditor.nameDesc', { provider: 'OpenCode' }))
      .addText((text) => {
    ...
    new Setting(contentEl)
      ...
      .setDesc(t('settings.agentEditor.descriptionDesc', { provider: 'OpenCode' }))
      .addText((text) => {
...
export class OpencodeAgentSettings {
  ...
  async render(): Promise<void> {
    ...
    headerEl.createSpan({
      text: t('settings.agentEditor.title', { provider: 'OpenCode' }),
    ...
    if (visibleAgents.length === 0) {
      ...
      emptyEl.setText(t('settings.agentEditor.noAgents', { provider: 'OpenCode' }));
      return;
    }
