...
function createMockIndicator() {
  ...
  indicator.addClass('grimoire-canvas-indicator');
...
function createMockContextRow() {
  const elements: Record<string, any> = {
    '.grimoire-selection-indicator': createMockEl(),
    '.grimoire-canvas-indicator': createMockIndicator(),
    '.grimoire-file-indicator': null,
    '.grimoire-image-preview': null,
  };
  elements['.grimoire-selection-indicator'].addClass('grimoire-selection-indicator');
  elements['.grimoire-selection-indicator'].addClass('grimoire-hidden');
...
describe('CanvasSelectionController', () => {
  ...
  it('keeps context row visible when editor selection indicator is visible', () => {
    ...
    editorIndicator.addClass('grimoire-selection-indicator');
    contextRowEl.querySelector.mockImplementation((selector: string) => {
      if (selector === '.grimoire-selection-indicator') return editorIndicator;
      return null;
    });
