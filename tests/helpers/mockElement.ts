...
const CLASS_DISPLAY: Record<string, string> = {
  'grimoire-browser-selection-indicator': 'block',
  'grimoire-canvas-indicator': 'block',
  'grimoire-context-meter': 'flex',
  'grimoire-file-indicator': 'none',
  'grimoire-image-preview': 'none',
  'grimoire-mcp-selector': 'flex',
  'grimoire-mode-selector': 'flex',
  'grimoire-permission-toggle': 'flex',
  'grimoire-selection-indicator': 'block',
  'grimoire-service-tier-toggle': 'flex',
  'grimoire-status-panel-bash': 'block',
  'grimoire-status-panel-bash-content': 'block',
  'grimoire-status-panel-bash-entry-content': 'block',
  'grimoire-status-panel-content': 'block',
  'grimoire-status-panel-todos': 'block',
  'grimoire-tab-content': 'flex',
  'grimoire-thinking-budget': 'flex',
  'grimoire-thinking-effort': 'flex',
};

const DISPLAY_CLASSES = new Set([
  'grimoire-hidden',
  'grimoire-visible-block',
  'grimoire-visible-flex',
...
export function createMockEl(tag = 'div'): any {
  ...
  const resolveDisplay = (): string | null => {
    if (classes.has('grimoire-hidden')) return 'none';
    if (classes.has('grimoire-visible-flex')) return 'flex';
    if (classes.has('grimoire-visible-block')) return 'block';
