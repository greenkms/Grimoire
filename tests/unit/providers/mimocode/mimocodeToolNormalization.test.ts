import {
  createMimocodeToolStreamAdapter,
  normalizeMimocodeToolInput,
} from '../../../../src/providers/mimocode/normalization/mimocodeToolNormalization';

describe('normalizeMimocodeToolInput', () => {
  it('maps websearch payloads to the WebSearch renderer shape', () => {
    expect(normalizeMimocodeToolInput('websearch', {
      action: {
        queries: [
          'obsidian plugin API',
          'obsidian docs',
  ...
  it('maps question payloads to the AskUserQuestion renderer shape', () => {
    expect(normalizeMimocodeToolInput('question', {
      questions: [{
        header: 'Tests',
        id: 'tests',
        multiple: true,
  ...
  it('maps todowrite statuses into the TodoWrite renderer shape', () => {
    expect(normalizeMimocodeToolInput('todowrite', {
      todos: [
