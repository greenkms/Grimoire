...
function clickButton(root: any, text: string): void {
  const buttons = findAllByClass(root, 'grimoire-instruction-btn');
...
describe('InstructionModal', () => {
  describe('onOpen', () => {
    it('renders the raw instruction text', () => {
      ...
      const originalEl = findByClass(contentEl, 'grimoire-instruction-original');
    ...
    it('starts in loading state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'grimoire-instruction-loading');
      expect(loadingEl).not.toBeNull();
      expect(loadingEl.hasClass('grimoire-hidden')).toBe(false);

      const clarificationEl = findByClass(contentEl, 'grimoire-instruction-clarification-section');
      expect(clarificationEl.hasClass('grimoire-hidden')).toBe(true);

      const confirmationEl = findByClass(contentEl, 'grimoire-instruction-confirmation-section');
      expect(confirmationEl.hasClass('grimoire-hidden')).toBe(true);
    });
    ...
    it('renders Cancel button in loading state', () => {
      ...
      const buttons = findAllByClass(contentEl, 'grimoire-instruction-btn');
  ...
  describe('showClarification', () => {
    it('transitions to clarification state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'grimoire-instruction-loading');
      expect(loadingEl.hasClass('grimoire-hidden')).toBe(true);

      const clarificationEl = findByClass(contentEl, 'grimoire-instruction-clarification-section');
      expect(clarificationEl.hasClass('grimoire-hidden')).toBe(false);
    });
    ...
    it('displays the clarification text', () => {
      ...
      const clarificationTextEl = findByClass(contentEl, 'grimoire-instruction-clarification');
  ...
  describe('showConfirmation', () => {
    it('transitions to confirmation state', () => {
      ...
      const confirmationEl = findByClass(contentEl, 'grimoire-instruction-confirmation-section');
      expect(confirmationEl.hasClass('grimoire-hidden')).toBe(false);
    });
    ...
    it('displays the refined instruction', () => {
      ...
      const refinedEl = findByClass(contentEl, 'grimoire-instruction-refined');
