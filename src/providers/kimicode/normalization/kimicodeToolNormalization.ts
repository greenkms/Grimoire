...
type KimicodeKnownToolName = keyof typeof TOOL_NAME_MAP;

function isPlainObject(value: unknown): value is Record<string, unknown> {
  return value !== null && typeof value === 'object' && !Array.isArray(value);
}

function isKnownToolName(value: unknown): value is KimicodeKnownToolName {
...
function toKnownToolName(value: string | undefined): KimicodeKnownToolName | null {
  if (!value) {
    return null;
  }
...
export function resolveKimicodeRawToolName(
...
export function normalizeKimicodeToolName(rawName: string | undefined): string {
...
export function normalizeKimicodeToolInput(
...
export function normalizeKimicodeToolUseResult(
  rawName: string | undefined,
  input: Record<string, unknown>,
  rawOutput: unknown,
...
export function createKimicodeToolStreamAdapter(): AcpToolStreamAdapter {
