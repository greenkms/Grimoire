...
describe('CodexHistoryStore', () => {
  ...
  describe('parseCodexSessionContent - event_msg handling', () => {
    ...
    it('strips Codex memory citations from restored assistant messages', () => {
      const content = [
        JSON.stringify({
          timestamp: '2026-03-27T00:00:00.000Z',
          type: 'response_item',
          payload: {
            type: 'message',
            role: 'user',
            content: [{ type: 'input_text', text: 'Create a note.' }],
          },
        }),
        JSON.stringify({
          timestamp: '2026-03-27T00:00:01.000Z',
        ...
        JSON.stringify({
          ...
          payload: {
            ...
            message: [
              ...
              '</citation_entries>',
              '<rollout_ids>',
              '019e97fa-4949-7c11-a3bb-540145b5d1d2',
              '</rollout_ids>',
              '</oai-mem-citation>',
            ].join('\n'),
          },
      ...
      expect(messages[1].content).not.toContain('oai-mem-citation');
    });
