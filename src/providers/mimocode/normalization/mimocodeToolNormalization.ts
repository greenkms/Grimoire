...
type MimocodeKnownToolName = keyof typeof TOOL_NAME_MAP;

function isPlainObject(value: unknown): value is Record<string, unknown> {
  return value !== null && typeof value === 'object' && !Array.isArray(value);
}

function isKnownToolName(value: unknown): value is MimocodeKnownToolName {
...
function toKnownToolName(value: string | undefined): MimocodeKnownToolName | null {
  if (!value) {
    return null;
  }
...
export function resolveMimocodeRawToolName(
...
export function normalizeMimocodeToolName(rawName: string | undefined): string {
...
export function normalizeMimocodeToolInput(
...
export function normalizeMimocodeToolUseResult(
  rawName: string | undefined,
  input: Record<string, unknown>,
  rawOutput: unknown,
...
export function createMimocodeToolStreamAdapter(): AcpToolStreamAdapter {
