...
export const DEFAULT_CODEX_STANDARD_MODEL: CodexModel = 'gpt-5.4';
...
export const DEFAULT_CODEX_MODELS: ProviderUIOption[] = [
  ...
  createCodexModelOption(DEFAULT_CODEX_STANDARD_MODEL, 'Strong'),
  createCodexModelOption(DEFAULT_CODEX_MINI_MODEL, 'Fast'),
  createCodexModelOption(CODEX_SPARK_MODEL, 'Ultra-fast'),
];
