...
describe('opencodeChatUIConfig', () => {
  ...
  it('keeps at least three OpenCode effort choices before thought-level discovery finishes', () => {
    const settings = {
      model: 'opencode:minimax-token-plan/minimax-m2',
      providerConfigs: {
        opencode: {
          discoveredModels: [
    ...
    expect(opencodeChatUIConfig.isAdaptiveReasoningModel(
