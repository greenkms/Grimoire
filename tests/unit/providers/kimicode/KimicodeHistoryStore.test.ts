import { mapKimicodeMessages } from '../../../../src/providers/kimicode/history/KimicodeHistoryStore';

describe('mapKimicodeMessages', () => {
  it('maps stored Kimi Code messages into Grimoire chat messages', () => {
    const messages = mapKimicodeMessages([
      {
        info: {
          id: 'msg-user',
          role: 'user',
  ...
  it('shows only the latest user turn when Kimi Code stores a rebuilt prompt with history', () => {
    const messages = mapKimicodeMessages([
      {
        info: {
          id: 'msg-user',
  ...
  it('merges adjacent assistant fragments from one Kimi Code turn', () => {
    const messages = mapKimicodeMessages([
      {
        info: {
          id: 'msg-user',
