...
const changelogMarkdown = readFileSync('CHANGELOG.md', 'utf-8');
...
const OBSIDIAN_PLUGIN_PATH = OBSIDIAN_VAULT && existsSync(OBSIDIAN_VAULT)
  ? path.join(OBSIDIAN_VAULT, '.obsidian', 'plugins', 'grimoire')
  : null;
...
const context = await esbuild.context({
  ...
  legalComments: 'eof',
  banner: {
    js: `/* Grimoire ${packageJson.version} - generated by esbuild; source is available in this repository. */`,
  },
  outfile: 'main.js',
});
