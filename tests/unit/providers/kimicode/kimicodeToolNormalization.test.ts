import {
  createKimicodeToolStreamAdapter,
  normalizeKimicodeToolInput,
} from '../../../../src/providers/kimicode/normalization/kimicodeToolNormalization';

describe('normalizeKimicodeToolInput', () => {
  it('maps websearch payloads to the WebSearch renderer shape', () => {
    expect(normalizeKimicodeToolInput('websearch', {
      action: {
        queries: [
          'obsidian plugin API',
          'obsidian docs',
  ...
  it('maps question payloads to the AskUserQuestion renderer shape', () => {
    expect(normalizeKimicodeToolInput('question', {
      questions: [{
        header: 'Tests',
        id: 'tests',
        multiple: true,
  ...
  it('maps todowrite statuses into the TodoWrite renderer shape', () => {
    expect(normalizeKimicodeToolInput('todowrite', {
      todos: [
