...
export type TranslationKey =
  ...
  | 'plugin.openChatView'
  | 'plugin.inlineEdit'
  | 'plugin.inlineEditViewUnavailable'
  | 'plugin.inlineEditInserted'
  | 'plugin.inlineEditApplied'
  | 'plugin.newTab'
  | 'plugin.newSession'
  | 'plugin.closeCurrentTab'
  | 'plugin.switchToTab'
  | 'plugin.environmentRestartFailed'
  | 'plugin.environmentAppliedRebuild'
  | 'plugin.environmentApplied'

  // Shared UI
  | 'shared.slashCommands.noMatches'
  | 'shared.resumeConversation.title'
  | 'shared.resumeConversation.empty'
  | 'shared.resumeConversation.current'
  | 'shared.instructionModal.title'
  | 'shared.instructionModal.yourInput'
  | 'shared.instructionModal.processingInstruction'
  | 'shared.instructionModal.yourResponse'
  | 'shared.instructionModal.responsePlaceholder'
  | 'shared.instructionModal.refinedSnippet'
  | 'shared.instructionModal.processing'
  | 'shared.instructionModal.submit'
  | 'shared.instructionModal.submitResponseAria'
  | 'shared.instructionModal.editAria'
  | 'shared.instructionModal.accept'
  | 'shared.instructionModal.acceptAria'
  | 'shared.instructionModal.preview'
  | 'shared.whatsNew.title'
  | 'shared.whatsNew.released'
  | 'shared.whatsNew.latestReleaseNotes'
  | 'shared.whatsNew.fullChangelog'
  | 'shared.whatsNew.gotIt'

  // Inline editing and storage
  | 'inlineEdit.rejectTitle'
  | 'inlineEdit.acceptTitle'
  | 'inlineEdit.editorUnavailable'
  | 'inlineEdit.vaultFilesLoadFailed'
  | 'inlineEdit.invalidFilePath'
